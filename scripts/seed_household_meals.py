...
RECIPES: list[tuple] = [
    ...
    (
        ...
        ["Heat the oven to 425F. Cut the potatoes into thin fries, toss with the oil and salt, and roast 35-40 minutes until crisp.",
         "Pat the steaks dry and season generously. Rest at room temperature while the fries cook.",
         "Sear the steaks in a hot pan 3-4 minutes per side for medium-rare.",
         "Add the butter and garlic, spoon over the steaks for a minute, then rest 5 minutes before serving with the fries."],
        ["steak"],
    ),
    (
    ...
    (
        ...
        [("steaks, about 8 oz each", "4", 4.0, None),
         ...
         ("neutral oil", "2", 2.0, "tbsp"),
         ("butter", "2", 2.0, "tbsp")],
        ["Heat the oven to 425F. Cut the potatoes into fries, toss with oil and salt, and roast 35-40 minutes until golden.",
         "Season the steaks well and let them sit while the fries cook.",
         "Sear 3-4 minutes per side, basting with the butter at the end.",
         "Rest the steaks 5 minutes, then serve with the fries."],
        ["steak"],
    ),
    (
    ...
    (
        "Grilled Chicken Thighs with Pineapple", 35,
        [("boneless chicken thighs", "4", 4.0, None),
        ...
        ["Whisk the soy, brown sugar, garlic and ginger and marinate the thighs 20 minutes.",
         ...
         "Grill the pineapple 2-3 minutes per side, until marked and caramelised, and serve with the chicken."],
        ["grilled"],
    ),
    (
    ...
    (
        ...
        [("boneless chicken thighs", "4", 4.0, None),
         ("pineapple, cut into rings", "1/2", 0.5, None),
         ("soy sauce", "3", 3.0, "tbsp"),
         ("brown sugar", "2", 2.0, "tbsp"),
         ("garlic cloves, minced", "2", 2.0, None),
         ("short-grain white rice", "1 1/2", 1.5, "cup")],
        ["Marinate the thighs in the soy, brown sugar and garlic for 20 minutes.",
         "Rinse the rice until the water runs clear, then cook it according to its directions and keep it covered.",
         "Grill the thighs 6-7 minutes per side until cooked through.",
         "Grill the pineapple 2-3 minutes per side and serve everything over the rice."],
        ["grilled"],
    ),
    (
